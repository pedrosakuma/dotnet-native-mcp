...
> `load_native_binary`, `list_native_symbols`, `resolve_symbol`, `extract_strings`, `symbolicate_stack`, `get_size_breakdown`, `explain_retention`, `compare_native_binaries`, `disassemble`.
