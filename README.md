...
> **Status:** early implementation phase. The repository serves
> `scaffold_status`, `load_native_binary`, and `get_size_breakdown` (V1 sidecar).
> Remaining native navigation tools land in V0 — see the
